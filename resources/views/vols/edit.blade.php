...
@method('PUT')
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" value="{{$vol->nombre_de_place}}" id="exampleInputPassword1"name="nombre_de_place">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Matricule</label>
    <input type="text" class="form-control" value="{{$vol->matricule}}" id="exampleInputPassword1"name="matricule">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Marque</label>
    <input type="text" class="form-control" value="{{$vol->marque}}" id="exampleInputPassword1"name="marque">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Date de création</label>
    <input type="date" class="form-control" value="{{$vol->date_de_creation}}" id="exampleInputPassword1"name="date_de_creation">
  </div>
